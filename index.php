...
<html>
	...
	<body onscroll="hide()"> 
		...
		<?php
			...
			$sql = "select user.firstname,user.lastname,user.email,user.status,blog.title,blog.blog from user, blog where user.email = blog.email order by id desc";
		?>
		<div id="container" >
			<div id = "header">
						...
						<div id="detail">
							<div class = "blog">';
								if($status=="active"){
									...
									echo'<span id="name1">Unknown User</span><br>
